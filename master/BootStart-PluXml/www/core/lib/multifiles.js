...
function MultiSelector( list_target, max, racine ){
	...
	this.addListRow = function( element ){
		...
		new_row.setAttribute("class","well well-small");
		new_row.setAttribute("className","well well-small"); /* Hack IE */
		// Delete link
		var new_row_button = document.createElement('a');
		new_row_button.setAttribute('href', 'javascript:void(0)');
		new_row_button.innerHTML = '<i class="icon-remove-sign"></i>';
		...
		new_row_div.setAttribute("class","pull-right");
		new_row_div.setAttribute("className","pull-right"); /* Hack IE */
