  ...
  <div class="subhead-inner">
    <div class="container"> 
      ...
      <div class="btn-toolbar pull-right">
        <div class="btn-group"> <a href="<?php echo PLX_CORE ?>admin/article.php" class="btn" rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo L_BUTTON_ADD_POST ?>"> <i class="icon-edit"></i> </a> <a href="<?php echo PLX_CORE ?>admin/statiques.php" class="btn" rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo L_BUTTON_ADD_PAGE ?>"> <i class="icon-list-alt"></i> </a> </div>
        <div class="btn-group"> <a href="<?php echo PLX_CORE ?>admin/medias.php" class="btn" rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo L_BUTTON_MANAGE_FILES ?>"> <i class="icon-cloud-upload"></i> </a> <a href="<?php echo PLX_CORE ?>admin/parametres_users.php" class="btn" rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo L_BUTTON_MANAGE_USERS ?>"> <i class="icon-group"></i> </a> <a href="<?php echo PLX_CORE ?>admin/comments.php" class="btn" rel="tooltip" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo L_BUTTON_MANAGE_COMMENTS ?>"> <i class="icon-comments"></i>
...
<div class="span1 pull-left well well-small sidebar-mini" id="sidebar"> <a class="hidden-phone" style="display:block;margin-top:15px" href="<?php echo PLX_CORE ?>admin/profil.php" rel="tooltip" data-toggle="tooltip" data-placement="right" data-original-title="<?php
...
<div class="span11 main pull-right" style="margin-left:0" id="content">
<?php
