...
class plxMyContact extends plxPlugin {
    ...
    public function plxShowStaticListEnd() {
		...
		if($this->getParam('mnuDisplay')) {
			...
			echo "<?php array_splice(\$menus, ".($this->getParam('mnuPos')-1).", 0, '<li role=\"menuitem\"><a role=\"link\" href=\"'.\$this->plxMotor->urlRewrite('?contact').'\" class=\"btn btn-mini '.\$class.'\" title=\"".$this->getParam('mnuName')."\">".$this->getParam('mnuName')."</a></li>'); ?>";
		}
